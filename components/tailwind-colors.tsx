...
export function TailwindColors() {
  ...
  const colorFamilies = Object.entries(tailwindColors).filter(([name]) =>
    ...
    <div className="min-h-screen bg-[#160b05] text-white">
      ...
      <div className="mx-auto max-w-6xl px-4 pt-24 pb-20 sm:px-6 sm:pt-40">
        ...
        >
          <div className="relative mx-auto max-w-md">
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-white/5 py-3 pl-12 pr-4 text-white placeholder-white/40 outline-none transition-colors focus:border-white/25 focus:bg-white/8"
            />
          </div>
        </motion.div>
        ...
        <div className="space-y-4">
          {colorFamilies.map(([name, shades], familyIndex) => (
            <motion.div
              key={name}
              ...
              <div className="grid grid-cols-6 gap-1 sm:flex sm:flex-1">
                {shadeKeys.map((shade) => {
                  ...
                  return (
                    <button
                      key={shade}
                      onClick={() => handleCopy(hex, swatchKey)}
                      className="group/swatch relative flex flex-1 cursor-pointer flex-col items-center justify-center rounded-lg transition-all duration-150 hover:scale-105 hover:shadow-lg hover:shadow-black/30"
                      style={{
                        backgroundColor: hex,
                        minHeight: "64px",
                      }}
                    ...
                    >
                      ...
                      <span
                        className="text-[10px] font-medium opacity-60 transition-opacity group-hover/swatch:opacity-0"
                      ...
                      {/* Hover: shade + hex */}
                      <div className="absolute inset-0 flex flex-col items-center justify-center opacity-0 transition-opacity group-hover/swatch:opacity-100">
                        <span
                        ...
                        <span
                          ...
                          style={{ color: light ? "rgba(0,0,0,0.7)" : "rgba(255,255,255,0.7)" }}
                        >
                          {hex}
                        </span>
                      </div>
                      ...
                      <AnimatePresence>
                        {isCopied && (
                          <motion.div
                            ...
                            style={{
                              backgroundColor: light ? "rgba(0,0,0,0.8)" : "rgba(255,255,255,0.9)",
                            }}
                          >
                            <span
          ...
          {colorFamilies.length === 0 && (
            <div className="py-20 text-center text-white/40">
              No colors found matching &ldquo;{search}&rdquo;
            </div>
          )}
        </div>
      </div>
