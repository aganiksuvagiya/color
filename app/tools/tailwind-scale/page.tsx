import { TailwindScaleTool } from "@/components/tailwind-scale-tool";
...
const page = toolPageContent["tailwind-scale"];
    ...
    <>
      ...
      <StructuredData
        data={buildBreadcrumbSchema([
          ...
          { name: "Tools", item: `${siteConfig.domain}/tools/tailwind-scale` },
