import { PaletteVisualizer } from "@/components/palette-visualizer";
...
const page = toolPageContent["palette-visualizer"];
    ...
    <>
      ...
      <StructuredData
        data={buildBreadcrumbSchema([
          ...
          { name: "Tools", item: `${siteConfig.domain}/tools/palette-visualizer` },
