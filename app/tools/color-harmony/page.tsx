import { ColorHarmonyTool } from "@/components/color-harmony-tool";
...
const page = toolPageContent["color-harmony"];
    ...
    <>
      ...
      <StructuredData
        data={buildBreadcrumbSchema([
          ...
          { name: "Tools", item: `${siteConfig.domain}/tools/color-harmony` },
