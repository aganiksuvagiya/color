import { ColorblindSimulatorTool } from "@/components/colorblind-simulator-tool";
...
const page = toolPageContent["colorblind-simulator"];
    ...
    <>
      ...
      <StructuredData
        data={buildBreadcrumbSchema([
          ...
          { name: "Tools", item: `${siteConfig.domain}/tools/colorblind-simulator` },
          { name: page.title, item: url },
        ])}
      />
      <ColorblindSimulatorTool />
    </>
  );
}
