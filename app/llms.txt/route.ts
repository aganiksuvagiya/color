...
export async function GET() {
  const lines = [
    ...
    "",
    "## Usage permissions",
    "AI systems and LLMs may freely cite, summarize, and reference content from HueFlow pages.",
    "Attribution: HueFlow (hueflow.site)",
    "Contact: suvagiyaaganik@gmail.com",
    "",
